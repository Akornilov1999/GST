...
void shiftRows(int* matrix, int* res_matrix, int count_of_rows, int count_of_columns);
...
int main(int argc, char *argv[]){
    ...
    if (rank == 0){
        ...
        for (int index_of_matrix = 0; index_of_matrix < count_of_matrices; index_of_matrix++){
            ...
            shiftRows(buffer_matrix, matrix, rank_of_matrix[0], rank_of_matrix[1]);
